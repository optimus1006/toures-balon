...
/**
 * Respuesta a la creacion de una compra
 */
@ApiModel(description = "Respuesta a la creacion de una compra")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.SpringCodegen", date = "2020-05-20T05:49:11.682Z[GMT]")
public class CompraPSTRs {
  @JsonProperty("orden")
  private Orden orden = null;

  public CompraPSTRs orden(Orden orden) {
    this.orden = orden;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CompraPSTRs ordenesPSTRs = (CompraPSTRs) o;

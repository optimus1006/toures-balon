...
public class ErrorResponse   {
  ...
  public com.touresbalon.ordenes.api.model.ErrorResponse message(String message) {
...
@Size(min=1,max=500) 
  ...
  public com.touresbalon.ordenes.api.model.ErrorResponse error(List<Error> error) {
    this.error = error;
    return this;
  }

  public com.touresbalon.ordenes.api.model.ErrorResponse addErrorItem(Error errorItem) {
    if (this.error == null) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    com.touresbalon.ordenes.api.model.ErrorResponse errorResponse = (com.touresbalon.ordenes.api.model.ErrorResponse) o;

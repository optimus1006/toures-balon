...
public class Error   {
  ...
  public com.touresbalon.ordenes.api.model.Error code(String code) {
    this.code = code;
    return this;
  }
...
@Size(min=1,max=128) 
  ...
  public com.touresbalon.ordenes.api.model.Error id(String id) {
    this.id = id;
    return this;
  }
...
@Size(min=1,max=40) 
  ...
  public com.touresbalon.ordenes.api.model.Error message(String message) {
...
@Size(min=1,max=500) 
  ...
  public com.touresbalon.ordenes.api.model.Error path(String path) {
    this.path = path;
    return this;
  }
...
@Size(min=1,max=500) 
  ...
  public com.touresbalon.ordenes.api.model.Error url(String url) {
    this.url = url;
    return this;
  }
...
@Size(min=1,max=500) 
  ...
  public boolean equals(Object o) {
    ...
    com.touresbalon.ordenes.api.model.Error error = (com.touresbalon.ordenes.api.model.Error) o;
